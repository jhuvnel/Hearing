...
%% Load data
[~,~,THI_vals] = xlsread('MVI-THI-AI-Results-2025-03-12.xlsx','THI');
THI_1 = cell2mat(THI_vals(find(groups==1)+2,2:12)); %preserved hearing
THI_0 = cell2mat(THI_vals(find(groups==0)+2,2:12)); %lost hearing
[~,~,AI_vals] = xlsread('MVI-THI-AI-Results-2025-03-12.xlsx','AI');
AI_1 = cell2mat(AI_vals(find(groups==1)+2,2:12)); %preserved hearing
AI_0 = cell2mat(AI_vals(find(groups==0)+2,2:12)); %lost hearing
%% Figure format
fig = figure(1);
...
plot(1:11,median(THI_1,'omitnan'),'k:','LineWidth',1.5)
plot(1:11,median(THI_0,'omitnan'),':','LineWidth',1.5,'Color',[0.2 0.2 0.2])
hold off 
...
set(bp,'LineWidth',linew,'LineStyle','-','Color','k');
plot(1:11,median(AI_1,'omitnan'),'k:','LineWidth',1.5)
plot(1:11,median(AI_0,'omitnan'),':','LineWidth',1.5,'Color',[0.2 0.2 0.2])
hold off 
for i = 1:size(AI_1,1)
    for j = 1:11
