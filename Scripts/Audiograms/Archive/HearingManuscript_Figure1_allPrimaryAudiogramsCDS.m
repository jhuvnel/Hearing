...
path2 = '20200902_qselHearingTests.mat';
...
visits = [0 3 9 10;
    ...
    0 3 9 10;
    0 3 9 10];
visitLabels = {'Pre-op','~3 wk post-op','6 mo post-op','1 yr post-op'};
...
% print text SRT,CNCW, @
if ~isempty(tempTbl)
    xposes = [270 285 700 1200];   % CDS052720 changed from [150 350 550 1100] and changed text alignment so LEFT ear score text doesn't overlap RIGHT ear scores
    ...
    text(xposes(1),yposes(3),'CNCW:','HorizontalAlignment','right'); % CDS052720 changed from [150 350 550 1100] and changed text alignment so LEFT ear score text doesn't overlap RIGHT ear scores
