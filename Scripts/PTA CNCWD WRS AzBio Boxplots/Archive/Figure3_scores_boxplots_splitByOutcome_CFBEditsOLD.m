...
% [~,~,THI_vals] = xlsread('MVI-THI-AI-Results-2023-05-23.xlsx','THI');
% THI = cell2mat(THI_vals(2:11,2:5));
% [~,~,AI_vals] = xlsread('MVI-THI-AI-Results-2023-05-23.xlsx','AI');
% AI = cell2mat(AI_vals(2:11,2:5));
%% parameters
...
conduction = {'BC','AC'};
% preOpArray_THI = zeros(length(patients),length(THI));
