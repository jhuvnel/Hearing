...
plot(xpos(1:end-1)-xshift,medianArrayHear(1:end-1),'k-','LineWidth',linew);
plot(xpos(1:end-1)+xshift,medianArrayNoHear(1:end-1),'k:','LineWidth',linew);
...
%plot(xpos(1:end-1)-xshift,medianQArrayHear(1:end-1),'k-','LineWidth',linew);
plot(xpos(1:end-1)-xshift,medianNArrayHear(1:end-1),':','LineWidth',linew,'Color',[0.2 0.2 0.2]);
%plot(xpos(1:end-1)-xshift,medianQArrayNoHear(1:end-1),'k-','LineWidth',linew);
plot(xpos(1:end-1)+xshift,medianNArrayNoHear(1:end-1),':','LineWidth',linew,'Color',[0.2 0.2 0.2]);
...
plot(xpos(1:end-1)-xshift,medianArrayHear(1:end-1),'k-','LineWidth',linew);
plot(xpos(1:end-1)+xshift,medianArrayNoHear(1:end-1),':','LineWidth',linew,'Color',[0.2 0.2 0.2]);
...
plot(xpos(1:end-1)-xshift,medianNArrayHear(1:end-1),'k-','LineWidth',linew);
%plot(xpos(1:end-1)-xshift,medianQArrayNoHear(1:end-1),'k-','LineWidth',linew);
plot(xpos(1:end-1)+xshift,medianNArrayNoHear(1:end-1),':','LineWidth',linew,'Color',[0.2 0.2 0.2]);
